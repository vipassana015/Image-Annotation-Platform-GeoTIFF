...
urlpatterns += [
    ...
    path(
        'datasets/<int:dataset_id>/images/',
        get_dataset_images
    ),

    path(
        'datasets/<int:dataset_id>/images/<int:image_id>/remove/',
    ...
    path(
        'projects/owned/',
        OwnedProjectsView.as_view()
    ),

    path(
        'projects/shared/',
        SharedProjectsView.as_view()
    ),
    ...
    path(
        ...
        DeleteBatchView.as_view()
    ),

    path(
        "projects/<int:project_id>/classes/",
